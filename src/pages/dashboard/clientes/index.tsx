...
export default function ClientesPage() {
  ...
  const [planFilter, setPlanFilter] = useState<CustomerPlan | null>(null);
  ...
  useEffect(() => {
    ...
    loadCustomers();
  }, [user, router, searchTerm, activeFilter, planFilter]);
  ...
  const loadCustomers = async () => {
    try {
      ...
      if (planFilter !== null) params.append("plan", planFilter);
      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex flex-wrap gap-4">
          ...
          <select
            ...
            onChange={(e) => {
              const value = e.target.value;
              setPlanFilter(value === "" ? null : (value as CustomerPlan));
            }}
            className="border rounded-lg px-4 py-2"
          >
